...
<head>
    ...
    <title>Nidhi Singh | Data Analyst Portfolio</title>
...
<body>
    <!-- Header -->
    <header>
        <div class="logo">Nidhi Singh | Data Analyst</div>
    </header>
    ...
    <section class="contact">
        <h2>Contact Me</h2>
        <p><b>Email:</b> <a href="mailto:nidhisgahlawat586@gmail.com">nidhisgahlawat586@gmail.com</a></p>
        <p><b>LinkedIn:</b> <a href="https://www.linkedin.com/in/nidhisinghmom/" target="_blank">LinkedIn Profile</a></p>
    </section>

    <!-- Footer -->
    <footer>
        <p>&copy; 2024 Nidhi Singh | Design by HTML5 UP</p>
    </footer>
</body>
</html>
